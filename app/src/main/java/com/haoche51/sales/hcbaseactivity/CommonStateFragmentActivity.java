 ...
 */
public abstract class CommonStateFragmentActivity extends FragmentActivity implements Validator.ValidationListener, HCHttpCallback {
  ...
  public CommonStateFragmentActivity() {
