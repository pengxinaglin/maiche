 ...
 */
public class TransferAuditFragment extends CommonBaseFragment implements AdapterView.OnItemClickListener, View.OnClickListener, HCPullToRefresh.OnRefreshCallback {
    ...
    public void onPullDownRefresh() {
        mCurrentPage = 0;
        requestFilterTransferData(HCConst.Transfer.HTTP_POST_TAB_TRANFER_AUDIT, ""
    ...
    public void doingFilter(Bundle where) {
        ...
        mCurrentPage = 0;
        requestFilterTransferData(HCConst.Transfer.HTTP_POST_TAB_TRANFER_AUDIT, key
                , mCurrentPage, HttpConstants.REQUEST_PAGESIZE, HttpConstants.GET_LIST_REFRESH);
    }
}
