 ...
 */
public class TransferFinishFragment extends CommonBaseFragment implements AdapterView.OnItemClickListener, View.OnClickListener, HCPullToRefresh.OnRefreshCallback {
    ...
    public void onPullDownRefresh() {
        mCurrentPage = 0;
        requestFilterTransferData(HCConst.Transfer.HTTP_POST_TAB_TRANFER_FINSH, ""
        ...
        try {
            switch (response.getErrno()) {
                case 0:
                    ...
                    //是否还有更多
                    boolean isNoMoreData = resultData.size() < TaskConstants.DEFAULT_SHOWTASK_COUNT;
    ...
    public void doingFilter(Bundle where) {
        ...
        mCurrentPage = 0;
        requestFilterTransferData(HCConst.Transfer.HTTP_POST_TAB_TRANFER_FINSH, key
                , mCurrentPage, HttpConstants.REQUEST_PAGESIZE, HttpConstants.GET_LIST_REFRESH);
    }
}
