...
public final class CalendarDay implements Parcelable {
     ...
     * Get a new instance set to the specified day
     *
     * @param calendar {@linkplain java.util.Calendar} to pull date information from. Passing null will return null
     *
     * @return CalendarDay set to the specified date
     */
     ...
     * Get a new instance set to the specified day
     *
     * @param date {@linkplain java.util.Date} to pull date information from. Passing null will return null.
     *
     * @return CalendarDay set to the specified date
     */
    ...
    /**
     * @see CalendarDay#from(java.util.Calendar)
     *
    ...
    /**
     * @see CalendarDay#from(java.util.Date)
     *
    ...
    /**
     * Get the month, represented by values from {@linkplain java.util.Calendar}
     *
    ...
    /**
     * Get this day as a {@linkplain java.util.Date}
     *
    ...
    /**
     * Get this day as a {@linkplain java.util.Calendar}
     *
