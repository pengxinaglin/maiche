...
public class CalendarUtils {
    ...
    /**
     * @param date {@linkplain java.util.Date} to pull date information from
     *
     ...
     *
     * @param calendar {@linkplain java.util.Calendar} to modify to be at the first fay of the month
     */
