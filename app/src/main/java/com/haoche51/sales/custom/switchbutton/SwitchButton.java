package com.haoche51.sales.custom.switchbutton;
...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta = attrs == null ? null : getContext().obtainStyledAttributes(attrs, R.styleable.pay_SwitchButton);
        if (ta != null) {
            thumbDrawable = ta.getDrawable(R.styleable.pay_SwitchButton_kswThumbDrawable);
            thumbColor = ta.getColorStateList(R.styleable.pay_SwitchButton_kswThumbColor);
            margin = ta.getDimension(R.styleable.pay_SwitchButton_kswThumbMargin, margin);
            marginLeft = ta.getDimension(R.styleable.pay_SwitchButton_kswThumbMarginLeft, margin);
            marginRight = ta.getDimension(R.styleable.pay_SwitchButton_kswThumbMarginRight, margin);
            marginTop = ta.getDimension(R.styleable.pay_SwitchButton_kswThumbMarginTop, margin);
            marginBottom = ta.getDimension(R.styleable.pay_SwitchButton_kswThumbMarginBottom, margin);
            thumbWidth = ta.getDimension(R.styleable.pay_SwitchButton_kswThumbWidth, thumbWidth);
            thumbHeight = ta.getDimension(R.styleable.pay_SwitchButton_kswThumbHeight, thumbHeight);
            thumbRadius = ta.getDimension(R.styleable.pay_SwitchButton_kswThumbRadius, Math.min(thumbWidth, thumbHeight) / 2.f);
            backRadius = ta.getDimension(R.styleable.pay_SwitchButton_kswBackRadius, thumbRadius + density * 2f);
            backDrawable = ta.getDrawable(R.styleable.pay_SwitchButton_kswBackDrawable);
            backColor = ta.getColorStateList(R.styleable.pay_SwitchButton_kswBackColor);
            backMeasureRatio = ta.getFloat(R.styleable.pay_SwitchButton_kswBackMeasureRatio, backMeasureRatio);
            animationDuration = ta.getInteger(R.styleable.pay_SwitchButton_kswAnimationDuration, animationDuration);
            fadeBack = ta.getBoolean(R.styleable.pay_SwitchButton_kswFadeBack, true);
            tintColor = ta.getColor(R.styleable.pay_SwitchButton_kswTintColor, tintColor);
            textOn = ta.getString(R.styleable.pay_SwitchButton_kswTextOn);
            textOff = ta.getString(R.styleable.pay_SwitchButton_kswTextOff);
            textMarginH = ta.getDimension(R.styleable.pay_SwitchButton_kswTextMarginH, textMarginH);
            ta.recycle();
        }
    ...
    public void setBackColorRes(int backColorRes) {
        ...
        setBackColor(resource.getColorStateList(backColorRes));
    }
    ...
    public void setThumbColorRes(int thumbColorRes) {
        Resources resource = getContext().getResources();
        setThumbColor(resource.getColorStateList(thumbColorRes));
    }
