...
public final class Constants {
  ...
  // 银�?支付安全支付服务apk的名称，必须与assets目录下的apk名称�?��
  public static final String YT_PLUGIN_NAME = "SecurePay.apk";

  public static final String RET_CODE_SUCCESS = "0000";// 0000 交易成功
  public static final String RET_CODE_CANCEL = "1006"; // 用户中途取消支付操作
  public static final String RET_CODE_PROCESS = "2008";// 2008 支付处理�?
